...
public class BucketController {
	...
	@PostMapping("/buckets/createBucket")
	//@PreAuthorize("hasRole('USER')")
	...
	@PostMapping("/buckets/addItemBucket")
	//@PreAuthorize("hasRole('USER')")
	...
	@DeleteMapping("/buckets/deleteItemeBucket")
	//@PreAuthorize("hasRole('USER')")
